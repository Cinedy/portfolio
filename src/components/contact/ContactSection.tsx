...
const links = [
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/silje-melling/",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className={styles.grid}>
        <div className={styles.left}>
          ...
          <p className={styles.bio}>
            ...
            collaboration, or opportunities. Drop me a message and
            I&apos;ll get back to you.
          </p>
        </div>
        <div className={styles.right}>
          {links.map((link) => (
            <a key={link.label} href={link.href} className={styles.row} target="_blank" rel="noopener noreferrer">
